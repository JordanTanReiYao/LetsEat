...
public class NavigationDrawerUI extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        if (savedInstanceState == null) {
            ...
            if (isFave) {
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new FavouritesUI(this),"favorite").commit();
    ...
    public void onBackPressed() {
        Fragment profile = (Fragment) getSupportFragmentManager().findFragmentByTag("profile");
        Fragment favorite=(Fragment) getSupportFragmentManager().findFragmentByTag("favorite");

        if (drawer.isDrawerOpen(GravityCompat.START)) {
            drawer.closeDrawer(GravityCompat.START);
        } else if (profile != null && profile.isVisible()) {
        ...
        //super.onBackPressed();
            /*startActivity(new Intent(NavigationDrawerUI.this, MainActivity.class));
            finish();*/
        else if (favorite != null && favorite.isVisible()) {
            // the code for whatever behaviour you want goes here
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new RestaurantListUI(this)).commit();
        }
