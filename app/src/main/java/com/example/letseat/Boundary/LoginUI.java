...
public class LoginUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ImageButton test=(ImageButton)findViewById(R.id.imageButton);
    ...
    /*private void tester(){
        final AlertDialog.Builder tt= new AlertDialog.Builder(this);
        final LinearLayout linearLayout = new LinearLayout(this);
        final TextView tty=new TextView(this);
        tty.setText("HELLO!!!!!");
        linearLayout.addView(tty);
        tt.setView(linearLayout);
        tt.create().show();
    }*/
    ...
    public void showRecoverPasswordDialog(final ProgressDialog pd, final FirebaseAuth mAuth){
    ...
    public void pwRecovery(String email, final ProgressDialog pd, FirebaseAuth mAuth){
        /*final progress_animation progress=new progress_animation().newInstance();
        progress.show(getSupportFragmentManager(),"");*/
        pd.setMessage("Sending email...");
        pd.show();
        Toast.makeText(LoginUI.this, "Sending Email", Toast.LENGTH_SHORT).show();
