...
public class User {
    ...
    public void setName(final String name, final ProgressDialog pd){
        ...
        test.add("3");
        test.add("4");
        DatabaseReference dbr  = firebaseDatabase.getReference("Users/"+user.getUid());
        Map<String,ArrayList<String>> review = new HashMap<>();
        review.put("review", test);
        dbr.child("Reviews").setValue(review);
