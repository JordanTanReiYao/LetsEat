...
public class RegisterUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MaterialEditText mUsername = findViewById(R.id.usernameET);
        final MaterialEditText mEmailEt = findViewById(R.id.emailET);
        final MaterialEditText mPasswordEt = findViewById(R.id.passwordET);
        Button mRegisterBtn = (Button)findViewById(R.id.registerBtn);
        final MaterialEditText mCfmPasswordEt = findViewById(R.id.cfmPasswordET);
