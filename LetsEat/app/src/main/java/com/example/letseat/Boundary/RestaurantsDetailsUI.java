...
public class RestaurantsDetailsUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(sfc.call(phone_number));
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(sfc.share(name, vicinity,googleMapsURL));
            }
        });
        ...
        directions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mapIntent = sfc.find(googleMapsURL);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot favouriteSnapshot : dataSnapshot.getChildren()){
                    ...
                    if (restaurant.getPlaceID().equals(restaurantClass.getPlaceID())  ){
                        ...
                        System.out.println("Lets Eat restaurant details On diff class insert removed!!: " + restaurantClass.getName() + restaurantClass.getRating());
                        return;
                    }
                }
                ...
                dbReference.child(id).setValue(restaurantClass).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(RestaurantsDetailsUI.this, "Favourite " + restaurantClass.getName(), Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        System.out.println("Lets Eat error adding favourites: " + e);
                        Toast.makeText(RestaurantsDetailsUI.this, "Unfavourite " + restaurantClass.getName(), Toast.LENGTH_SHORT).show();
